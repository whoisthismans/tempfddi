            ...
            <div class="container">
                ...
                <div class="students-affairs-blcok">
					...
					<span class="news-details-img">
                        <h3>A seminar by All India Rubber Industries Association (Northern Region)</h3>
					</span>
                        <p>A seminar by All India Rubber Industries Association (Northern Region) is being organised on 24th January ( 3 - 5 p.m.) in FDDI, Noida. The venue is Seminar hall of the New Building.</p>
                        <span class="news-details-img">
                            <img class="img-responsive" src="img/seminar-invite.jpg" alt="">
                        </span>
